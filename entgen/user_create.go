...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.UUID(); !ok {
		return &ValidationError{Name: "uuid", err: errors.New(`entgen: missing required field "User.uuid"`)}
	}
	if _, ok := uc.mutation.Password(); !ok {
		return &ValidationError{Name: "password", err: errors.New(`entgen: missing required field "User.password"`)}
	}
	return nil
}
