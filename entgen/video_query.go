...
func (vgb *VideoGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(vgb.fields) > 1 {
		return nil, errors.New("entgen: VideoGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := vgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vgb *VideoGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{video.Label}
	default:
		err = fmt.Errorf("entgen: VideoGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (vgb *VideoGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(vgb.fields) > 1 {
		return nil, errors.New("entgen: VideoGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := vgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vgb *VideoGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{video.Label}
	default:
		err = fmt.Errorf("entgen: VideoGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (vgb *VideoGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(vgb.fields) > 1 {
		return nil, errors.New("entgen: VideoGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := vgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vgb *VideoGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{video.Label}
	default:
		err = fmt.Errorf("entgen: VideoGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (vgb *VideoGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(vgb.fields) > 1 {
		return nil, errors.New("entgen: VideoGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := vgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vgb *VideoGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{video.Label}
	default:
		err = fmt.Errorf("entgen: VideoGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (vs *VideoSelect) Strings(ctx context.Context) ([]string, error) {
	if len(vs.fields) > 1 {
		return nil, errors.New("entgen: VideoSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := vs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vs *VideoSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{video.Label}
	default:
		err = fmt.Errorf("entgen: VideoSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (vs *VideoSelect) Ints(ctx context.Context) ([]int, error) {
	if len(vs.fields) > 1 {
		return nil, errors.New("entgen: VideoSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := vs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vs *VideoSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{video.Label}
	default:
		err = fmt.Errorf("entgen: VideoSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (vs *VideoSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(vs.fields) > 1 {
		return nil, errors.New("entgen: VideoSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := vs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vs *VideoSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{video.Label}
	default:
		err = fmt.Errorf("entgen: VideoSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (vs *VideoSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(vs.fields) > 1 {
		return nil, errors.New("entgen: VideoSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := vs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vs *VideoSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{video.Label}
	default:
		err = fmt.Errorf("entgen: VideoSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
